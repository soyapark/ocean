...
function logEvent(event, customName, customInfo) {
  ...
  var state = getUrlParameter('team') || "";

  if (ENABLE_CONSOLE_LOGGING) {
    console.log(uid, time, name, target, info, state, LOG_VERSION);
  }
  if (ENABLE_NETWORK_LOGGING) {
    sendOceanLogging(uid, time, name, target, info, state, LOG_VERSION);
  }
}
...
// Ocean logging submission function
// submits to the google form at this URL:
// docs.google.com/forms/d/e/1FAIpQLSdxEjR0qchTEd0biWO_8nmlH3_8ZQBR75ENLBRrHaZUVgLxJg/viewform
function sendOceanLogging(
    uid,
    time,
    name,
    target,
    ...
    state,
    version) {
  var formid = "e/1FAIpQLSdxEjR0qchTEd0biWO_8nmlH3_8ZQBR75ENLBRrHaZUVgLxJg";
  var data = {
