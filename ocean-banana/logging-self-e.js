...
function logEvent(event, customName, customInfo) {
  ...
  if (ENABLE_NETWORK_LOGGING) {
    sendOceanLoggingSelfEApple(uid, time, name, target, info, state, LOG_VERSION);
  }
}
...
// Ocean logging - self-E apple submission function
// submits to the google form at this URL:
// docs.google.com/forms/d/e/1FAIpQLSeyQM87E-viP3WSBQ0Gu1QW54EJwe5uVNE2ynzhMTdXBHteSA/viewform
function sendOceanLoggingSelfEApple(
    uid,
    time,
    name,
    target,
    ...
    state,
    version) {
  var formid = "e/1FAIpQLSeyQM87E-viP3WSBQ0Gu1QW54EJwe5uVNE2ynzhMTdXBHteSA";
  var data = {
