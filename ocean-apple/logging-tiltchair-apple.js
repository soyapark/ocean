...
function logEvent(event, customName, customInfo) {
  ...
  if (ENABLE_NETWORK_LOGGING) {
    sendOceanLoggingTiltchairApple(uid, time, name, target, info, state, LOG_VERSION);
  }
}
...
// Ocean logging - TiltChair apple submission function
// submits to the google form at this URL:
// docs.google.com/forms/d/e/1FAIpQLSfj0EeC6iQLe0DKzNXKC3T9RBkwqym-Pra5zrOLWrw2NJqENQ/viewform
function sendOceanLoggingTiltchairApple(
    uid,
    time,
    name,
    target,
    ...
    state,
    version) {
  var formid = "e/1FAIpQLSfj0EeC6iQLe0DKzNXKC3T9RBkwqym-Pra5zrOLWrw2NJqENQ";
  var data = {
